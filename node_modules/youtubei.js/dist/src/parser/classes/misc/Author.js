...
class Author {
    constructor(item, badges, thumbs) {
        ...
        __classPrivateFieldSet(this, _Author_nav_text, new NavigatableText(item), "f");
        this.id =
